...
def local_generate(
    model, tokenizer, system_prompt, user_prompt, max_new_tokens=4096,
    device="cpu", enable_thinking=None, use_qwen_template=False,
...
def main():
    ...
    parser.add_argument("--log", default="chemprot-answer-sp.log", help="日志文件名")
    ...
    parser.add_argument("--temperature", type=float, default=1.0, help="采样温度，控制生成多样性")
    parser.add_argument("--top_k", type=int, default=50, help="采样top_k，控制生成多样性")
